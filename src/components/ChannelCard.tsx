        ...
        {channel.image ? (
          <img
            ...
            onError={(e) => {
              ...
              const gradientColors = channel.bgGradient.replace('from-', '').replace('to-', '').split(' ').join(', ');
              e.currentTarget.parentElement!.style.background = `linear-gradient(to right, ${gradientColors})`;
            }}
            onLoad={() => {
